      ...
      <div className="w-full flex flex-col items-center gap-6">
        ...
        <div className="p-4 flex flex-col items-center gap-6">
          <div className="flex gap-4 flex-wrap justify-center">
            {!outputOn && (
              <IconButton
                label={displayMode === "json-to-csharp" ? t("JsonParaCsharp") : t("CsharpParaJson")}
                onClick={process}
              ...
              >
                  {displayMode === "json-to-csharp" ?
                    ...
                    :
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" className="bi bi-filetype-json" viewBox="0 0 16 16">
