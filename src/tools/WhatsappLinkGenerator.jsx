                ...
                <div className="flex gap-4">
                    {!linkAlreadyGenerated && (
                        <IconButton
                            ...
                            className={`px-8 py-3 rounded-lg font-medium ${(isButtonDisabled || linkAlreadyGenerated)
                    ...
                    {linkAlreadyGenerated && (
                        <IconButton
                            ...
                            className={`px-8 py-3 rounded-lg font-medium ${!linkAlreadyGenerated && !copied
                                ? "default-button-inactive opacity-50 cursor-not-allowed"
                                : "default-button-active hover:scale-105 transition-transform"
                                }`}
                        >
