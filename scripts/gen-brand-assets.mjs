...
// Path do mascote (mesmo de src/components/Logo.jsx)
const OTTER =
...
const ogSvg = `<svg xmlns="http://www.w3.org/2000/svg" width="1200" height="630" viewBox="0 0 1200 630">
  <defs>
    <linearGradient id="bg" x1="0" y1="0" x2="1" y2="1">
      ...
      <stop offset="1" stop-color="#16002e"/>
    </linearGradient>
  ...
  <g transform="translate(459 58) scale(0.44)" fill="#ffffff">
    <path d="${OTTER}"/>
  </g>
  <text x="600" y="430" text-anchor="middle" font-family="Segoe UI, Arial, sans-serif" font-weight="700" font-size="150" letter-spacing="-4" fill="#ffffff">Gera<tspan fill="#ff6b35">Dev</tspan></text>
  <text x="600" y="500" text-anchor="middle" font-family="Segoe UI, Arial, sans-serif" font-weight="500" font-size="38" letter-spacing="2" fill="#c9aef0">Ferramentas para desenvolvedores</text>
</svg>`;
